...
// SECURED MODULE LISTENERS
$( `.secured-module` ).on( `click`, (e) => {

    // e.preventDefault();    
    // authenticateModule( e )
        ...
        var settings = {
            ...
            "success": ( responseObj ) => {                    
                if( ! responseObj.error ) {
                    swal( `Success!`, `Authentication is successful`, `success` );
                    return true;
                } else {
                    swal( `Forbidden!`, responseObj.data[0].msg, `error` );
                    setTimeout( () => {
